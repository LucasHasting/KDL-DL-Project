...
def load_data(info, move, state):
    ...
    return [*screen_data, *tile_data, game_state, boss_health, kirby_y, kirby_y_scrol, kirby_x_scrol, kirby_x, move, state]
...
def write_to_csv(data, filename):
    ...
    column += ["kirby_x_scrol", "kirby_x", "move", "state"]
...
def main():
    ...
    while(True):
        ...
        #record the data
        data.append(load_data(info, move, state))
